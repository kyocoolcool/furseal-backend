//package com.kyocoolcool.keycloak.backend.infra.security.annotation;
//
...
//
//    @Before("@annotation(com.kyocoolcool.keycloak.backend.infra.security.annotation.AllowedRoles)")
